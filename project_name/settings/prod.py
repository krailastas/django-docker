...
# https://docs.djangoproject.com/en/{{ docs_version }}/ref/settings/#email-host-user
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', '')

# https://docs.djangoproject.com/en/{{ docs_version }}/ref/settings/#email-host-password
...
# https://docs.djangoproject.com/en/{{ docs_version }}/ref/settings/#server-email
